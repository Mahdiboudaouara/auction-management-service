            ...
            steps {
                script {
                    if (params.DEPLOY_TO == 'EC2') {
                        ...
                        build job: "helm-auction/main", propagate: true, wait: true
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'github', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                        ...
                        sh "git remote set-url origin https://${USER}:${PASS}@github.com/Mahdiboudaouara/auction-management-service.git"
                        sh 'git add .'
