...
async function createAuction(req, res) {
  ...
  const insertData =
    "INSERT INTO products (productName,owner_id,category_id,productDescription,productImage,date) VALUES (?,?,?,?,?,?)";
  await db.query(
    insertData,
    [
    ...
    (err, result) => {
      ...
      Axios.post(`http://${process.env.BID_SERVER}/backend/bid/create`, {
        productId: productId,
